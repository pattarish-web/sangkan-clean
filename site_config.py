...
SERVICE_LANDINGS = [
    {
        ...
        "why_html": "<li>ประสบการณ์กว่า 30 ปี คุมคุณภาพงานประจำได้สม่ำเสมอ</li><li>เลือกน้ำยาและอุปกรณ์ตามชนิดพื้นผิว ลดความเสี่ยงสีซีด/ผิวถลอก</li><li>มีประกันความเสียหายจากการปฏิบัติงาน และทีมสำรองเข้าทดแทนได้</li><li>จองง่ายผ่าน LINE @sangkanclean หรือโทร 063-686-5134</li>",
        ...
        "faq5_a": "แนะนำอย่างน้อย 2-3 วัน หากเคสด่วนโทรสอบถามคิวว่างได้ทันทีที่ 063-686-5134",
    },
    {
        "file": "landing-glass",
